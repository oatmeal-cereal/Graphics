...
int FrameBuffer::writeRGBFile(char *filename)
{
  ...
  // The next blocks of code implement an auto exposure on the framebuffer

  // Find the maximum value of any channel.
  // If it exceeds 1.0 use this to scale the outout to have this as the peak value.
  // Otherwise use 1.0
