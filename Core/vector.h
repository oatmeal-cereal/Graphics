...
public:
	...
	friend bool operator==(Vector a, Vector other) {
		if (a.x == other.x && a.y == other.y && a.z == other.z) {
	...
	friend std::ostream &operator<<(std::ostream &os, const Vector& v) {
		string vectorstring = to_string(v.x) + ' ' + to_string(v.y) + ' ' + to_string(v.z);
		return std::operator<<(os, vectorstring);
	}
